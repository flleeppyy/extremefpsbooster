...
extremefps.config.ropes = false -- Disable some core aspects of the ropes. This does not disable ropes entirely, it just disables things that can take up some GPU usage
...
extremefps.config.drawmonitors = true -- I suggest this is kept true because if you
